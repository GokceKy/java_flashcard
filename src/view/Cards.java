...
public class Cards extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        WordDAOImpl wordDAO = WordDAOImpl.getInstance();
        // WordDAOImpl wordDAO2 = WordDAOImpl.getInstance();
        //   if(wordDAO2 ==wordDAO){
        ...
        try {
            ...
            English_Word englishWord = (English_Word) factory.createWord(nextId, kelime_eng, kelime_tr, seviye);
            ...
            if (tur == "deyim") {
                try {
                    English_Word idiom = englishWord.clone();
                    idiom.setTur(tur);
